...
// opens on the detail page near the first research rows; FlashCut covers the cut.
const DETAIL_CAM: CamKey[] = [
  { frame: 0, cx: 960, cy: 1500, zoom: 1.1 },
  { frame: 75, cx: 960, cy: 1800, zoom: 1.0 }, // 75 ≤ duration 100
];
...
export const SCENE_DETAIL_DEFAULTS = {
  accent: '#e85d3a', // ember accent — embed seam colour
};
