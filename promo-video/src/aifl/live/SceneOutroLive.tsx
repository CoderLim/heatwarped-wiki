...
export const SceneOutroLive: React.FC<SceneOutroProps> = (props) => {
  const { wordmark, wordmarkSize, tagline, taglineSize, ink, amber, muted } = {
  ...
  const CAM: CamKey[] = [{ frame: 0, cx: 960, cy: 2100, zoom: 0.7 }];
    ...
    <AbsoluteFill style={{ opacity: fadeOut }}>
      ...
      >
        <PageCam
          ...
          saturate={0.9}
        />
        {/* bunker scrim under the flying elements */}
        <AbsoluteFill
          style={{
            background:
              'radial-gradient(1200px 800px at 50% 48%, rgba(7,9,15,0.72), rgba(7,9,15,0.55) 60%, rgba(7,9,15,0.4))',
            pointerEvents: 'none',
          }}
        />
        ...
        <AbsoluteFill style={{ pointerEvents: 'none' }}>
          {ELS.map((el) => {
            ...
            const texture = el.wbrCrop
              ? {
                  background: `#10141f url(${staticFile(`textures/live/${el.file}`)}) -576px -173px / 1920px ${WBR_PAGE_H}px no-repeat`,
                ...
                {showGlow ? (
                  <div
                    style={{
                      ...
                      borderRadius: '50%',
                      background:
                        'radial-gradient(circle, rgba(232,93,58,0.9), rgba(232,93,58,0) 70%)',
                      opacity: glow,
        ...
        >
          <div
            style={{
              ...
              width: 600,
              background:
                'linear-gradient(90deg, rgba(255,106,58,0), rgba(255,106,58,0.85) 50%, rgba(255,106,58,0))',
      ...
      {stageLight > 0 ? (
        <AbsoluteFill
          style={{
            pointerEvents: 'none',
            background:
              'radial-gradient(700px 360px at 960px 470px, rgba(232,93,58,0.55), rgba(232,93,58,0.18) 55%, rgba(232,93,58,0) 75%)',
            opacity: stageLight,
          }}
        />
      ) : null}
      ...
      {vignette > 0 ? (
        <AbsoluteFill
          style={{
            pointerEvents: 'none',
            background:
              'radial-gradient(1400px 900px at 50% 50%, rgba(7,9,15,0) 55%, rgba(7,9,15,0.85) 100%)',
            opacity: vignette,
          }}
        />
      ) : null}
