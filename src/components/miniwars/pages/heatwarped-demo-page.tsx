...
const faqItems = [
  ...
  {
    question: 'What should I do if the Heatwarped demo will not install or launch?',
    answer:
...
export function HeatwarpedDemoPage() {
  const howToSchema = {
    ...
    step: [
      ...
      { '@type': 'HowToStep', text: 'Use the demo download or install control on the Heatwarped store page.' },
      { '@type': 'HowToStep', text: 'Let Steam install the Heatwarped demo through the Steam client.' },
    ...
    <>
      ...
      <section className="border-camo-900 relative overflow-hidden border-b">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-16 md:py-20">
          <div className="text-ember-500 mb-4 font-mono text-xs tracking-[0.35em] uppercase">
            Heatwarped demo · official download guide · verified {DEMO_VERIFIED_DATE}
          </div>
          ...
          <p className="text-bunker-200 mt-6 max-w-3xl text-lg leading-8">
            The Heatwarped demo is available free on Steam. This page explains the official download route, current PC requirements, what is confirmed about the public demo, and what remains unannounced.
          </p>
        </div>
      </section>
      ...
      <article className="mx-auto max-w-5xl px-4 py-12">
        ...
        <ol className="text-bunker-200 mt-4 list-decimal space-y-3 pl-6 text-base leading-8">
          ...
          <li>Let Steam install the Heatwarped demo through the normal Steam client workflow.</li>
          <li>Launch the Heatwarped demo from your Steam Library after installation completes.</li>
        </ol>
        <Paragraph>
          Heatwarped also has an <ExternalSource href={OFFICIAL_SITE_URL}>official website</ExternalSource> that currently promotes the demo. For the Steam version, use Valve's store and client rather than a third-party mirror. This wiki does not host a Heatwarped installer, APK, repack, torrent, or unofficial download package.
        </Paragraph>

        <H2>Heatwarped demo PC requirements</H2>
        <Paragraph>
          The current official Heatwarped Steam page publishes both minimum and recommended Windows PC specifications. These requirements can change while Heatwarped is still in development, so the Steam listing remains the source of truth.
        </Paragraph>
        <div className="border-camo-800 mt-5 overflow-x-auto border">
          <table className="w-full min-w-[44rem] text-left text-sm">
            <thead className="bg-bunker-900/75">
              <tr>
                <th className="text-camo-300 px-4 py-3 font-mono text-[11px] tracking-widest uppercase">Component</th>
                <th className="text-ember-400 px-4 py-3 font-mono text-[11px] tracking-widest uppercase">Minimum</th>
                <th className="text-camo-300 px-4 py-3 font-mono text-[11px] tracking-widest uppercase">Recommended</th>
              </tr>
            </thead>
            <tbody>
              {[
                ['OS', 'Windows 10 (64-bit)', 'Windows 11 (64-bit)'],
                ['Processor', 'AMD FX 8320 / Intel Core i5-3570K', 'AMD Ryzen 5 5500 / Intel Core i5-12400F'],
                ['Memory', '4 GB RAM', '8 GB RAM'],
                ['Graphics', 'Nvidia GeForce GTX 960 / AMD Radeon HD 7970', 'Nvidia GeForce GTX 1070 / AMD RX 5600 XT'],
                ...
                <tr key={label} className="border-camo-800 border-t">
                  <th className="text-camo-300 bg-bunker-900/40 px-4 py-3 font-mono text-[10px] tracking-widest uppercase">{label}</th>
        ...
        <div className="mt-6">
          <Link className="btn-ghost" href="/system-requirements">
            Full Heatwarped system requirements <ArrowRight className="h-4 w-4" />
          </Link>
        </div>

        <H2>What is officially confirmed about the Heatwarped demo?</H2>
        <Paragraph>
          The official Steam page confirms that a Heatwarped demo is publicly available, while the official Heatwarped website prominently directs visitors to download the demo. Heatwarped itself is officially described on Steam as an open-world arcade street racing game set in the 2000s, with adrenaline driving, deep customization, rich environments, and a soundtrack built around racing and night driving.
        </Paragraph>
        <Paragraph>
          The official sources checked for this page do not publish a complete written inventory of every demo race, car, map boundary, unlock, playtime estimate, or save-transfer rule. This page therefore avoids presenting third-party observations as developer-confirmed demo scope. For a broader look at the confirmed game concept, see the <Link className="text-ember-400 underline underline-offset-4" href="/gameplay">Heatwarped gameplay guide</Link>.
        </Paragraph>

        <H2>Heatwarped demo troubleshooting</H2>
        <Paragraph>
          If the Heatwarped demo does not install or launch, first stay within the Steam workflow: confirm that Steam is signed in, the demo download finishes, and the PC meets the published Heatwarped requirements above. If performance is poor, compare your hardware against the minimum and recommended specifications before applying community launch flags or unofficial tweaks. No dedicated Heatwarped troubleshooting document was found in the primary sources checked for this update.
        </Paragraph>
        ...
        <div className="border-camo-800 mt-5 border">
          <div className="grid gap-3 p-5 sm:grid-cols-[10rem_1fr]">
            <time className="text-ember-400 font-mono text-xs tracking-widest uppercase" dateTime="2026-08-27">
              Aug 27, 2026
            </time>
            <div className="text-bunker-200 text-sm leading-7">
              Re-verified that the official Steam page and Heatwarped website still promote the free demo. Updated the FAQ markup, visible FAQ, PC requirements, source notes, and page modification date.
            </div>
          </div>
        </div>
        ...
        <div className="border-camo-800 bg-bunker-900/55 mt-8 border p-4 text-sm leading-7">
          ...
          <div className="text-bunker-200">
            Demo availability and PC specifications are checked against the <ExternalSource href={STEAM_URL}>official Heatwarped Steam listing</ExternalSource>. Demo promotion and game-level positioning are cross-checked against the <ExternalSource href={OFFICIAL_SITE_URL}>official Heatwarped website</ExternalSource>. Last verified {DEMO_VERIFIED_DATE}.
          </div>
        </div>
      </article>
    </>
